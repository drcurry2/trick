...
class MonteCarloVariable
{
 ...
 protected:
  ...
  double lower_bound; /* (--)
      Lower Bound value for MonteCarloVariableType::Uniform Distribution.*/
  double upper_bound; /* (--)
      Upper Bound value for MonteCarloVariableType::Uniform Distribution.*/
  double mean; /* (--)
      Mean value for MonteCarloVariableType::Gauss Distribution.*/
  double sigma;/* (--)
      Std dev value for MonteCarloVariableType::Gauss Distribution.*/
