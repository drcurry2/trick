...
class MonteCarloVariableRandom : public MonteCarloVariable
{
 ...
 public:
  MonteCarloVariableRandom(const std::string & var_name, unsigned int seed = 0,MonteCarloVariableType type_in = MonteCarloVariable::Undefined): MonteCarloVariable(var_name),random_generator(seed),seed_m(seed) //changed seed member variable to seed_m
  {
    type = type_in;
  }
